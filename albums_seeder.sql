...
VALUES ('jcole', 'rise and shine', 2011, 'rap/hip hop'),
       ('lionheart','burn', 2019, 'screamo rock'),
       ('m.a.g.s','drugs', 2020, 'indie');

INSERT INTO albums (artist, name, release_date, genre)
VALUES ('empire of the sun', 'walking on a dream', 2008, 'indie');
